...
class DetailViewController: UIViewController {
    ...
    @objc func shareTapped() {
        ...
        //Challenge 1: Try adding the image name to the list of items that are shared. The activityItems parameter is an array, so you can add strings and other things freely.
